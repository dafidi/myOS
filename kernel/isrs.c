...
void __install_isrs64(void) {
    set_idt64_entry(0,  addr_to_u64(&asm_isr64_0), 0x08,  0x0, 0x8E);
    set_idt64_entry(1,  addr_to_u64(&asm_isr64_1), 0x08,  0x0, 0x8E);
    set_idt64_entry(2,  addr_to_u64(&asm_isr64_2), 0x08,  0x0, 0x8E);
    set_idt64_entry(3,  addr_to_u64(&asm_isr64_3), 0x08,  0x0, 0x8E);
    set_idt64_entry(4,  addr_to_u64(&asm_isr64_4), 0x08,  0x0, 0x8E);
    set_idt64_entry(5,  addr_to_u64(&asm_isr64_5), 0x08,  0x0, 0x8E);
    set_idt64_entry(6,  addr_to_u64(&asm_isr64_6), 0x08,  0x0, 0x8E);
    set_idt64_entry(7,  addr_to_u64(&asm_isr64_7), 0x08,  0x0, 0x8E);
    set_idt64_entry(8,  addr_to_u64(&asm_isr64_8), 0x08,  0x0, 0x8E);
    set_idt64_entry(9,  addr_to_u64(&asm_isr64_9), 0x08,  0x0, 0x8E);
    set_idt64_entry(10, addr_to_u64(&asm_isr64_10), 0x08, 0x0, 0x8E);
    set_idt64_entry(11, addr_to_u64(&asm_isr64_11), 0x08, 0x0, 0x8E);
    set_idt64_entry(12, addr_to_u64(&asm_isr64_12), 0x08, 0x0, 0x8E);
    // Use actual IST entries for GP and PF errors because we actually hit them.
    set_idt64_entry(13, addr_to_u64(&asm_isr64_13), 0x08, 0x01, 0x8E);
    set_idt64_entry(14, addr_to_u64(&asm_isr64_14), 0x08, 0x01, 0x8E);
    set_idt64_entry(15, addr_to_u64(&asm_isr64_15), 0x08, 0x0, 0x8E);
    set_idt64_entry(16, addr_to_u64(&asm_isr64_16), 0x08, 0x0, 0x8E);
    set_idt64_entry(17, addr_to_u64(&asm_isr64_17), 0x08, 0x0, 0x8E);
    set_idt64_entry(18, addr_to_u64(&asm_isr64_18), 0x08, 0x0, 0x8E);
    set_idt64_entry(19, addr_to_u64(&asm_isr64_19), 0x08, 0x0, 0x8E);
    set_idt64_entry(20, addr_to_u64(&asm_isr64_20), 0x08, 0x0, 0x8E);
    set_idt64_entry(21, addr_to_u64(&asm_isr64_21), 0x08, 0x0, 0x8E);
    set_idt64_entry(22, addr_to_u64(&asm_isr64_22), 0x08, 0x0, 0x8E);
    set_idt64_entry(23, addr_to_u64(&asm_isr64_23), 0x08, 0x0, 0x8E);
    set_idt64_entry(24, addr_to_u64(&asm_isr64_24), 0x08, 0x0, 0x8E);
    set_idt64_entry(25, addr_to_u64(&asm_isr64_25), 0x08, 0x0, 0x8E);
    set_idt64_entry(26, addr_to_u64(&asm_isr64_26), 0x08, 0x0, 0x8E);
    set_idt64_entry(27, addr_to_u64(&asm_isr64_27), 0x08, 0x0, 0x8E);
    set_idt64_entry(28, addr_to_u64(&asm_isr64_28), 0x08, 0x0, 0x8E);
    set_idt64_entry(29, addr_to_u64(&asm_isr64_29), 0x08, 0x0, 0x8E);
    set_idt64_entry(30, addr_to_u64(&asm_isr64_30), 0x08, 0x0, 0x8E);
    set_idt64_entry(31, addr_to_u64(&asm_isr64_31), 0x08, 0x0, 0x8E);
}
